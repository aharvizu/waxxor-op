...
9. **Mensajes recientes**: última interacción por conversación con filtros No atendidos/Míos/Sin asignar/Todos y acciones (abrir, registrar respuesta, marcar atendida — auditada). "Crear ticket desde conversación" no aplica: las conversaciones son 1:1 con ticket.
