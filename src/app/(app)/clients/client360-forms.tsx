    ...
    <form action={formAction} className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <Field label="Estado" name="status" errors={errors}>
          <SelectInput name="status" value={value} options={metaOptions(CLIENT_STATUSES, clientStatusMeta)} />
        </Field>
...
export function NoteComposer({ clientId }: { clientId: number }) {
