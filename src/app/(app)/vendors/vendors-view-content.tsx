...
import { VENDOR_COLUMN_OPTIONS, KanbanView, ListView, TableView, type VendorRow } from "./vendor-views";

/** Client-side owner of the Views Engine experience for Proveedores. Mirrors companies-view-content.tsx. */
export function VendorsViewContent({
  views,
  activeViewId,
  currentUserId,
  currentUserRole,
