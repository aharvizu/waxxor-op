...
export const INDICATOR_DEFINITIONS: readonly IndicatorDefinition[] = [
  ...
  {
    key: "clients_attended",
    name: "Clientes atendidos",
    description: "Empresas distintas con al menos un ticket creado en el periodo.",
    formula: "count(distinct work_items.company_id) donde created_at ∈ periodo",
    unit: "count",
    source: "tickets + work_items",
    drillDownRoute: "/companies",
    emptyState: "Sin clientes atendidos en el periodo.",
  },
  {
    key: "technicians_active",
    name: "Técnicos activos",
    description: "Técnicos distintos con tiempo registrado o un ticket asignado creado en el periodo.",
    formula: "count(distinct user_id) en time_entries.date ∈ periodo ∪ assignee_id de tickets creados ∈ periodo",
    unit: "count",
    source: "time_entries + tickets + work_items",
    drillDownRoute: "/users",
    emptyState: "Sin técnicos con actividad en el periodo.",
  },
  {
    key: "hours_worked",
    ...
    source: "time_entries",
    drillDownRoute: null,
    emptyState: "Sin horas registradas en el periodo.",
  },
  {
    key: "cost_total",
    name: "Costo total generado",
    description: "Suma de importes calculados de todos los tickets creados en el periodo, sin filtrar por estado de cobro.",
    formula: "sum(calculated_amount) where work_items.created_at ∈ periodo",
    unit: "currency",
    source: "tickets",
    drillDownRoute: "/helpdesk",
  ...
  },
  {
    ...
    formula: "horas trabajadas / total de tickets",
    unit: "minutes",
    source: "time_entries + tickets",
    drillDownRoute: null,
    emptyState: "Sin tickets en el periodo — el promedio no aplica.",
  },
  {
    key: "avg_cost_per_ticket",
    name: "Promedio de costo por ticket",
    description: "Costo total generado entre tickets creados en el periodo.",
    formula: "costo total generado / total de tickets",
    unit: "currency",
    source: "tickets",
    drillDownRoute: null,
    emptyState: "Sin tickets en el periodo — el promedio no aplica.",
  ...
  {
    key: "billable_tickets",
    name: "Tickets cobrables",
    description: "Tickets del periodo con importe calculado mayor a $0.",
    formula: "count(*) where calculated_amount > 0",
    unit: "count",
    source: "tickets",
    drillDownRoute: "/helpdesk",
    emptyState: "Sin tickets cobrables en el periodo.",
  },
  {
    key: "no_cost_tickets",
    name: "Tickets sin costo",
    description: "Tickets del periodo con importe calculado nulo o $0.",
    formula: "total de tickets − tickets cobrables",
    unit: "count",
    source: "tickets",
    drillDownRoute: "/helpdesk",
    emptyState: "Todos los tickets del periodo tienen costo.",
  },
  {
    key: "remote_tickets",
    name: "Tickets remotos",
    description: "Tickets del periodo con modalidad de cobro remota.",
    formula: "count(*) where billing_modality = 'remote'",
    unit: "count",
    source: "tickets",
    drillDownRoute: "/helpdesk",
    emptyState: "Sin tickets remotos en el periodo.",
  },
  {
    key: "onsite_tickets",
    name: "Tickets en sitio",
    description: "Tickets del periodo con modalidad de cobro en sitio.",
    formula: "count(*) where billing_modality = 'onsite'",
    unit: "count",
    source: "tickets",
    drillDownRoute: "/helpdesk",
    emptyState: "Sin tickets en sitio en el periodo.",
  },
  {
    key: "remote_pct",
    name: "% de tickets remotos",
    description: "Proporción de tickets del periodo con modalidad remota.",
    formula: "tickets remotos / total de tickets × 100",
    unit: "percent",
    source: "tickets",
    drillDownRoute: null,
    emptyState: "Sin tickets en el periodo — el porcentaje no aplica.",
  },
  {
    key: "onsite_pct",
    name: "% de tickets en sitio",
    description: "Proporción de tickets del periodo con modalidad en sitio.",
    formula: "tickets en sitio / total de tickets × 100",
    unit: "percent",
    source: "tickets",
    drillDownRoute: null,
    emptyState: "Sin tickets en el periodo — el porcentaje no aplica.",
